...
class Utility {
  ...
  static customSnackBar(BuildContext context, String msg, {double height = 30, Color backgroundColor = Colors.black}) {
  ...
  static Future<Uri> createLinkToShare(BuildContext context, String id,
    ...
    final DynamicLinkParameters parameters = DynamicLinkParameters(
      uriPrefix: 'https://twitter.page.link',
      link: Uri.parse('https://twitter.com/$id'),
      androidParameters: AndroidParameters(
        packageName: 'com.haluuvananh.flutter_twitter_clone_dev',
        minimumVersion: 0,
      ),
