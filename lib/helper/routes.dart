...
import '../ui/page/Auth/selectAuthMethod.dart';
...
import '../ui/page/message/conversationInformation/conversationInformation.dart';
import '../ui/page/message/newMessagePage.dart';
import '../ui/page/profile/follow/followerListPage.dart';
import '../ui/page/profile/profilePage.dart';
import '../ui/page/search/SearchPage.dart';
import '../ui/page/settings/accountSettings/about/aboutTwitter.dart';
import '../ui/page/settings/accountSettings/accessibility/accessibility.dart';
import '../ui/page/settings/accountSettings/accountSettingsPage.dart';
import '../ui/page/settings/accountSettings/contentPrefrences/contentPreference.dart';
import '../ui/page/settings/accountSettings/contentPrefrences/trends/trendsPage.dart';
import '../ui/page/settings/accountSettings/dataUsage/dataUsagePage.dart';
import '../ui/page/settings/accountSettings/displaySettings/displayAndSoundPage.dart';
import '../ui/page/settings/accountSettings/notifications/notificationPage.dart';
import '../ui/page/settings/accountSettings/privacyAndSafety/directMessage/directMessage.dart';
import '../ui/page/settings/accountSettings/privacyAndSafety/privacyAndSafetyPage.dart';
import '../ui/page/settings/accountSettings/proxy/proxyPage.dart';
import '../ui/page/settings/settingsAndPrivacyPage.dart';
...
class Routes {
  ...
  static Route? onGenerateRoute(RouteSettings settings) {
    ...
    switch (pathElements[1]) {
      ...
      case "ImageViewPge":
        return CustomRoute<bool>(builder: (BuildContext context) => const ImageViewPge());
      case "ChatScreenPage":
        return CustomRoute<bool>(builder: (BuildContext context) => const ChatScreenPage());
      case "NewMessagePage":
        return CustomRoute<bool>(
      ...
      case "NotificationPage":
        return CustomRoute<bool>(
          builder: (BuildContext context) => const NotificationPageSetting(),
        );
