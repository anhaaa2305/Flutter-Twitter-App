...
import 'package:twitter/widgets/bottomMenuBar/tabItem.dart';
  ...
  Widget _iconRow() {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
          ...
          boxShadow: const [BoxShadow(color: Colors.black12, offset: Offset(0, -.1), blurRadius: 0)]),
      child: Row(
        ...
        child: AnimatedAlign(
          ...
          child: AnimatedOpacity(
            ...
            child: IconButton(
              ...
              icon: isCustomIcon
                  ? customIcon(context, icon: icon!, size: 22, isTwitterIcon: true, isEnable: index == state.pageIndex)
                  : Icon(
                      iconData,
