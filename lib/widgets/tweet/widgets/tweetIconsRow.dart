...
import '../../../ui/page/common/usersListPage.dart';
...
class TweetIconsRow extends StatelessWidget {
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          _iconWidget(
            ...
            icon: model.likeList!.any((userId) => userId == authState.userId) ? AppIcon.heartFill : AppIcon.heartEmpty,
            onPressed: () {
      ...
      children: <Widget>[
        ...
        Row(
          children: <Widget>[
            ...
            customText('Twitter for iOS', style: TextStyle(color: Theme.of(context).primaryColor))
          ],
        ),
  ...
  Widget customSwitcherWidget({required child, Duration duration = const Duration(milliseconds: 500)}) {
