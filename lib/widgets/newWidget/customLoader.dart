...
class CustomLoader {
  ...
  _buildLoader() {
    _overlayEntry = OverlayEntry(
      builder: (context) {
        return SizedBox(height: double.infinity, width: double.infinity, child: buildLoader(context));
      },
    );
  }
...
class CustomScreenLoader extends StatelessWidget {
  ...
  const CustomScreenLoader({Key? key, this.backgroundColor = const Color(0xfff8f8f8), this.height = 30, this.width = 30})
      : super(key: key);
