...
import '../../../ui/page/profile/follow/followingListPage.dart';
import '../../../ui/page/profile/profileImageView.dart';
import '../../../ui/page/profile/qrCode/scanner.dart';
import '../../../ui/page/profile/widgets/circular_image.dart';
import '../../../ui/page/profile/widgets/tabPainter.dart';
...
class _ProfilePageState extends State<ProfilePage> with SingleTickerProviderStateMixin {
                    ...
                    return PopupMenuItem<Choice>(
                      ...
                      child: Text(
                        ...
                        style: TextStyles.textStyle14
                            .copyWith(color: choice.isEnable ? AppColor.secondary : AppColor.lightGrey),
                      ),
                    );
                  }).toList();
                },
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        AnimatedContainer(
                          ...
                          decoration:
                              BoxDecoration(border: Border.all(color: Colors.white, width: 5), shape: BoxShape.circle),
                          child: RippleButton(
                            child: CircularImage(
                            ...
                            onPressed: () {
                              Navigator.push(context, ProfileImageView.getRoute(authState.profileUserModel.profilePic!));
                            },
                          ),
                        ),
                        Container(
                                  ...
                                  : RippleButton(
                                      ...
                                      child: Container(
                                        ...
                                        decoration: BoxDecoration(
                                            border: Border.all(
                                                color: isMyProfile ? Colors.black87.withAlpha(180) : Colors.blue, width: 1),
  ...
  bool isFollower() {
    ...
    if (authState.profileUserModel.followersList != null && authState.profileUserModel.followersList!.isNotEmpty) {
      return (authState.profileUserModel.followersList!.any((x) => x == authState.userId));
    } else {
      return false;
    }
  }
  ...
  void shareProfile(BuildContext context) async {
    ...
    Utility.createLinkAndShare(
      ...
      socialMetaTagParameters: SocialMetaTagParameters(
        description:
            !user.bio!.contains("Edit profile") ? user.bio : "Checkout ${user.displayName}'s profile on Twitter app",
        title: "${user.displayName} is on Twitter app",
  ...
  Widget _tweetList(BuildContext context, ProfileState authState, List<FeedModel>? tweetsList, bool isReply, bool isMedia) {
    List<FeedModel>? list;
      ...
      children: <Widget>[
        ...
        Padding(
          ...
          child: Row(
            children: <Widget>[
              ...
              user.isVerified!
                  ? customIcon(context,
                      icon: AppIcon.blueTick, isTwitterIcon: true, iconColor: AppColor.primary, size: 13, paddingIcon: 3)
        ...
        Padding(
          ...
          child: Row(
            ...
            children: <Widget>[
              customIcon(context,
                  icon: AppIcon.locationPin, size: 14, isTwitterIcon: true, paddingIcon: 5, iconColor: AppColor.darkGrey),
              const SizedBox(width: 10),
              Expanded(
                child: customText(
                  user.location,
        ...
        Padding(
          ...
          child: Row(
            children: <Widget>[
              customIcon(context,
                  icon: AppIcon.calender, size: 14, isTwitterIcon: true, paddingIcon: 5, iconColor: AppColor.darkGrey),
              const SizedBox(width: 10),
              customText(
